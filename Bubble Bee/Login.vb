                    ...
                    While rd.Read()
                        ...
                        Else
                            ...
                            ElseIf txt_akses.Text = "Kasir" Then
                                ...
                                MenuStaff.txt_saldo.Text = rd!koin
                            ...
                            ElseIf txt_akses.Text = "Owner" Then
                                ...
                                MenuStaff.btn_report.Visible = True
                                If Not MenuStaff.cmb_akses.Items.Contains("Customer") And Not MenuStaff.cmb_akses.Items.Contains("Operator") And Not MenuStaff.cmb_akses.Items.Contains("Kasir") Then
                                    MenuStaff.cmb_akses.AddItem("Customer")
                                    MenuStaff.cmb_akses.AddItem("Operator")
                                    MenuStaff.cmb_akses.AddItem("Kasir")
                                End If
                                MenuStaff.Form_DetailPeriode.Visible = False
                                MenuStaff.Form_Log.Visible = False
                                MenuStaff.Form_Setting.Visible = False
